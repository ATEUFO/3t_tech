...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  const topBeams = useMemo(() => isMounted ? generateBeams() : [], [generateBeams, isMounted])
  const rightBeams = useMemo(() => isMounted ? generateBeams() : [], [generateBeams, isMounted])
  const bottomBeams = useMemo(() => isMounted ? generateBeams() : [], [generateBeams, isMounted])
  const leftBeams = useMemo(() => isMounted ? generateBeams() : [], [generateBeams, isMounted])
